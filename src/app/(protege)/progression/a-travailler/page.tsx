...
export default async function PageCompetencesATravailler({
  searchParams,
}: {
  ...
  return (
    <div>
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <h1 className="font-display text-2xl italic text-encre">À travailler</h1>
