...
export async function VueGalerie({
  searchParams,
}: {
  ...
  if (activiteIdsDuDomaine !== null) {
    requete = requete.in(
      "activite_id",
      activiteIdsDuDomaine.length > 0 ? activiteIdsDuDomaine : ["00000000-0000-0000-0000-000000000000"]
    );
  }
  ...
  return (
    <div>
      ...
      >
        <input type="hidden" name="vue" value="galerie" />
        <div>
