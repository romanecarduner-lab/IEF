  ...
  return (
    <div className="rounded-doux border border-argile/30 bg-argile/5 p-4">
      <p className="mb-3 text-sm text-encre">
        Une fois finalisé, le contenu de ce journal sera figé. Le PDF sera
        généré maintenant.
      </p>
